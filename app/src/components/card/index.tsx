                ...
                <div className="panel">
                    <div className="panel-body text-center">
                        <div className="col-md-6">
                            <h4 className='oswald-header'><b>{request.building}</b></h4>
                        ...
                        <div className="col-md-6">
                            <h5><b>{request.submitted}</b></h5>
                            <h4 className='oswald'><b>{request.issue}</b></h4>
                            <h5>"{request.description}"</h5>
                            <p className='hidden-sm hidden-md hidden-lg hidden-xl'>Request ID: {request.cartegraphID}</p>
                            <div style={feedback}>
                                <h5 className='ubuntu'><b>DPW Feedback</b></h5>
                                <h5 className='ubuntu'>Status: {request.status}</h5>
                                <h5 className='ubuntu'>Last activity: {request.lastModified}</h5>
                                <h5 className='ubuntu'><i>{request.notes}</i></h5>
                            </div>
                        </div>
                    </div>
                </div>
