...
type props = types.openRequest & types.issues & types.user & actionProps;
...
export class Form extends React.Component<props, any> {
  ...
  render() {
    const { openRequest, issues, clearRequest } = this.props;
          ...
          <div className="col-md-12 text-center">
            ...
            <LoadingImage
              ...
              src={
                ...
                openRequest.building.replace(/ /g, "_") +
                pngOrJpg(openRequest.building)
              }
            />
          </div>
          <div className="col-md-12 text-center">
