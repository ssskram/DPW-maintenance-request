...
export const actionCreators = {
  loadAllRequests: (): AppThunkAction<any> => dispatch => {
    fetch(
      "https://cartegraphapi.azurewebsites.us/maintenanceRequests/allRequests",
      {
        method: "get",
        headers: new Headers({
...
export const reducer: Reducer<types.allRequests> = (
  state: types.allRequests,
  ...
  switch (action.type) {
    ...
    case constants.addRequest:
      return {
        ...state,
        allRequests: state.allRequests.concat(action.request)
      };
  }
